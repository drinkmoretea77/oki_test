(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-LeadsItem"],{
  ...
  return _c("div", { staticClass: "leads-item note note-info" }, [
    _c("div", { staticClass: "row" }, [
      ...
      _c(
        ...
        [_c("BalanceInfo", { tag: "div", attrs: { lead: _vm.lead } })],
        1
      )
    ]),
    _vm._v(" "),
    _vm.lead.sibling_companies
      ? _c("div", { staticClass: "row" }, [
          _c(
            ...
            [_c("SiblingCompanies", { tag: "div", attrs: { lead: _vm.lead } })],
            1
          )
        ])
      : _vm._e()
