...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
        ...
        $('.dropdown-quick-sidebar-toggler a, .page-quick-sidebar-toggler, .quick-sidebar-toggler').click(function (e) {
            $('#companies_sidebar').toggleClass('page-quick-sidebar-open');
        });
    };
    ...
    var handleQuickSidebarChat = function () {
        ...
        var initChatSlimScroll = function () {
            ...
            if ($('#side_tab_content').length) {
                content = $('#side_tab_content');
            } else {
                content = $('.page-quick-sidebar-chat-users');
            }
            ...
            if (content.length) {
                content.css('height', chatUsersHeight);
        ...
        wrapper.find('.page-quick-sidebar-chat-users .media-list > .media i').click(function () {
